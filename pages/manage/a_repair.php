                                    ...
                                    <?php
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td class='fs-12'>{$dataid['ar_tel']}</td>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $dataSt = $repairObj->getDatastatusByRepair("tb_a_datastatus",$r_id);
                                            // print_r($dataSt);
                                            foreach($dataSt as $row){
                                                $date = datethai_time($row['ds_date']);
                                                $ds2['s_id'] = $row['as_id'];
                                                $ds2['s_name'] = $row['as_name'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class=''><?php echo $das2['bt'];?> <?php echo $row['as_name'];?></td>
   ...
   <?php
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">ข้อมูลการดำเนินงาน สถานะแจ้งซ่อม <?php echo $dataid['as_id'];?></h4>
                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control show-tick" name="s_id">
                                            <?php
                                                $datast2 = $comboboxObj->getStatusManage("tb_a_status",$dataid['as_id'],$_SESSION['sts_id']);
                                                foreach($datast2 as $st){
                                                    echo "
                                                        <option value='{$st['as_id']}'>{$st['as_name']}</option>
                                                    ";
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" id="table" value="tb_a_datastatus" name="table" required readonly>
                    ...
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <div class="form-line">
                                        <textarea class="form-control" id="ads_remark" rows="3" name="ds_remark" ></textarea>
    ...
    <script>
        function myFunction(id,re) {
            ...
            var remark = document.getElementById("ads_remark");
            ds.value = id;
            remark.value = re;
        }
    </script>
