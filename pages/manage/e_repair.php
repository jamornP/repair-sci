...
<body class="theme-deep-orange font-kanit">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Widgets -->
            <div class="row">
                <a href="/repair-sci/pages/manage/e_repair.php?c=งานที่เรียบร้อย">
                ...
                <a href="/repair-sci/pages/manage/e_repair.php?c=งานค้าง">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/e_repair.php?c=งานรออะไหล่">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/e_repair.php?c=งานจ้างเหมา">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $dataSt = $repairObj->getDatastatusByRepair("tb_e_datastatus",$r_id);
                                            // print_r($dataSt);
                                            foreach($dataSt as $row){
                                                $date = datethai_time($row['ds_date']);
                                                $ds2['s_id'] = $row['es_id'];
                                                $ds2['s_name'] = $row['es_name'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class=''><?php echo $das2['bt'];?> <?php echo $row['es_name'];?></td>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $datar = $repairObj->getRepairByStatus($_SESSION['year'],"tb_e_repair",$text_sql);
                                            $r = count($datar);
                                            if($r>0){
                                                // print_r($datar);
                                                $i = 0;
                                                ...
                                                foreach($datar as $data){
                                                    ...
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td class=' align-justify'>
                                                                <a href='/repair-sci/pages/manage/e_repair.php?id={$r_idl}'>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" id="table" value="tb_e_datastatus" name="table" required readonly>
