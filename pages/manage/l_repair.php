...
<body class="theme-deep-orange font-kanit">
    ...
    <?php
        $all = $notifiObj->countAll($_SESSION['year'],"tb_l_repair");
        $danger = $notifiObj->countNoSuccess($_SESSION['year'],"tb_l_repair");
        $success = $notifiObj->countStatus($_SESSION['year'],"tb_l_repair",8);
        $wait = $notifiObj->countStatus($_SESSION['year'],"tb_l_repair",7);
        $company = ($notifiObj->countStatus($_SESSION['year'],"tb_l_repair",6))+($notifiObj->countStatus($_SESSION['year'],"tb_l_repair",9));
        // $success = 200;
    ?>
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Widgets -->
            <div class="row">
                <a href="/repair-sci/pages/manage/l_repair.php?c=งานที่เรียบร้อย">    
                ...
                <a href="/repair-sci/pages/manage/l_repair.php?c=งานค้าง">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/l_repair.php?c=งานรออะไหล่">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/l_repair.php?c=ส่งบริษัทซ่อม">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <?php
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td class='fs-12'>{$dataid['lr_tel']}</td>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $dataSt = $repairObj->getDatastatusByRepair("tb_l_datastatus",$r_id);
                                            // print_r($dataSt);
                                            foreach($dataSt as $row){
                                                $date = datethai_time($row['ds_date']);
                                                $ds2['s_id'] = $row['ls_id'];
                                                $ds2['s_name'] = $row['ls_name'];
                                                $das2 = statusIT($ds2);
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class=''><?php echo $das2['bt'];?> <?php echo $row['ls_name'];?></td>
                                    ...
                                    <tbody>
                                        <?php
                                            switch ($_GET['c']){
                                                ...
                                                break;
                                                case "งานค้าง":
                                                    $text_sql=" (r.ls_id < 8 AND (r.ls_id <> 6 AND r.ls_id <> 7))";
                                                break;
                                                case "งานรออะไหล่":
                                                    $text_sql=" r.ls_id = 7";
                                                break;
                                                case "ส่งบริษัทซ่อม":
                                                    $text_sql=" (r.ls_id = 6 OR r.ls_id = 9)";
                                                break;
                                                default:
                                                    $text_sql=" r.ls_id < 99";
                                            }
                                            $datar = $repairObj->getRepairByStatus($_SESSION['year'],"tb_l_repair",$text_sql);
                                            $r = count($datar);
                                            if($r>0){
                                                // print_r($datar);
                                                $i = 0;
                                                ...
                                                foreach($datar as $data){
                                                    ...
                                                    $s = "";
                                                    $dataSt1 = $comboboxObj->getDataStatusById("tb_l_status",$data['ls_id']);
                                                    $dss['s_id'] = $dataSt1['ls_id']; 
                                                    $dss['s_name'] = $dataSt1['ls_name']; 
                                                    $das = statusIT($dss);
                                                    $s = $das['bt'];
                                                    ...
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td class=' align-justify'>
                                                                <a href='/repair-sci/pages/manage/l_repair.php?id={$r_idl}'>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $datar = $repairObj->getAllRepair($_SESSION['year'],"tb_l_repair");
                                            $r = count($datar);
                                            if($r>0){
                                                // print_r($datar);
                                                $i = 0;
   ...
   <?php
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">ข้อมูลการดำเนินงาน สถานะแจ้งซ่อม <?php echo $dataid['ls_id'];?></h4>
                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control show-tick" name="s_id">
                                            <?php
                                                $datast2 = $comboboxObj->getStatusManage("tb_l_status",$dataid['ls_id'],$_SESSION['sts_id']);
                                                foreach($datast2 as $st){
                                                    echo "
                                                        <option value='{$st['ls_id']}'>{$st['ls_name']}</option>
                                                    ";
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" id="table" value="tb_l_datastatus" name="table" required readonly>
                    ...
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <div class="form-line">
                                        <textarea class="form-control" id="lds_remark" rows="3" name="ds_remark" ></textarea>
    ...
    <script>
        function myFunction(id,re) {
            ...
            var remark = document.getElementById("lds_remark");
            ds.value = id;
            remark.value = re;
        }
    </script>
