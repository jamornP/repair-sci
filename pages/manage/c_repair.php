...
<body class="theme-deep-orange font-kanit">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Widgets -->
            <div class="row">
                <a href="/repair-sci/pages/manage/c_repair.php?c=งานที่เรียบร้อย">    
                ...
                <a href="/repair-sci/pages/manage/c_repair.php?c=งานค้าง">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/c_repair.php?c=งานรออะไหล่">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <a href="/repair-sci/pages/manage/c_repair.php?c=ส่งบริษัทซ่อม">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <?php
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td class='fs-12'>{$dataid['cr_tel']}</td>
                                    ...
                                    <tbody>
                                        <?php
                                            switch ($_GET['c']){
                                                ...
                                                break;
                                                case "งานค้าง":
                                                    $text_sql=" (r.cs_id < 8 AND (r.cs_id <> 6 AND r.cs_id <> 7))";
                                                break;
                                                case "งานรออะไหล่":
                                                    $text_sql=" r.cs_id = 7";
                                                break;
                                                case "ส่งบริษัทซ่อม":
                                                    $text_sql=" (r.cs_id = 6 OR r.cs_id = 9)";
                                                break;
                                                default:
                                                    $text_sql=" r.cs_id < 99";
                                            }
                                            $datar = $repairObj->getRepairByStatus($_SESSION['year'],"tb_c_repair",$text_sql);
                                            $r = count($datar);
                                            if($r>0){
                                                // print_r($datar);
                                                $i = 0;
