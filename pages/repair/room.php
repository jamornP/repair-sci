...
<body class="theme-deep-orange font-kanit">
    ...
    <?php
        ...
        $success = $notifiObj->countStatus($_SESSION['year'],"tb_r_repair",3);
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>แจ้งซ่อมเครื่องคอมพิวเตอร์ห้องเรียน</h2>
            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <div class="form-line"> -->
                                        ...
                                        <input type="hidden" class="form-control" id="form_name" value="room" name="form_name" required readonly>
                                    <!-- </div>
                                </div>
                            </div>
                        </div> -->
