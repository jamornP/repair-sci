...
<?php //$_SESSION['year']=2567;?>
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    รายงานการซ่อมเครื่องคอมพิวเตอร์ห้อง LAB คณะ
    ...
    <script>
        ...
        function showYear(){
            $.get('year.php?table=tb_l_repair',function(data){
                // console.log(data);
                Morris.Area({
                    element: 'bar_chart_y',
                    data: data,
        ...
        function showMonth2(){
            $.get('building.php?table=tb_l_repair',function(data){
                // console.log(data);
                Morris.Donut({
        ...
        function showMonth(){
            $.get('month.php?table=tb_l_repair',function(data){
                // console.log(data);
                Morris.Area({
                    element: 'bar_chart_m',
                    data: data,
